...
def one_cycle(init_dict, manual_control_path, manual_actions_path, sensor_log_path, ml_action_log, alert_log, max_log_size, interval):
    """
...
def event_loop(init_dict, manual_control_path, manual_actions_path, sensor_log_path, ml_action_log, alert_log, max_log_size, interval, max_iter=None):
    """
